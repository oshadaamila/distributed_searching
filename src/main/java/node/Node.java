...
public class Node {
    private static String FILE_LIST_PATH = "./classes/FileNames.txt";
    private static String QUERY_LIST_PATH = "./classes/Queries.txt";
...
//        );
    ...
    private void refreshHistory() {
        ...
        for (SearchQuery query : queryHistory) {
            if (System.currentTimeMillis() - query.getParsedTime() < 3000) {
                temp.add(query);
            }
        }
        queryHistory = temp;
    ...
    public void leaveNetwork() throws IOException {
        ...
        if(this.unregistered){
            ...
            System.out.println("Leaving Unsuccessful");
        }
